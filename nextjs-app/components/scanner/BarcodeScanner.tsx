...
/**
 * Camera + manual barcode/QR scanner using jsQR.
 * Opens as a modal; supports manual entry when hideManual=false.
 */
      ...
      >
          ...
          <div className="p-4 border-b border-slate-200 flex gap-2">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-lg font-medium transition-colors ${
                !useCamera ? "bg-blue-600 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"
              }`}
            >
              Manual Input
            </button>
        ...
        <div className="p-4">
          {!useCamera && !hideManual ? (
            <>
              <p className="mb-4 text-sm text-slate-500">Masukkan nomor resi/tracking untuk mengisi otomatis</p>
              ...
              <div className="relative bg-slate-900 rounded-xl overflow-hidden aspect-square mb-4">
                ...
                {scanning && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-48 h-48 border-4 border-blue-500 rounded-2xl animate-pulse" />
                  </div>
                )}
              </div>

              <p className="text-center text-sm text-slate-600">Arahkan kamera ke barcode/QR code pada paket</p>
            </>
          )}
        </div>
      </div>
